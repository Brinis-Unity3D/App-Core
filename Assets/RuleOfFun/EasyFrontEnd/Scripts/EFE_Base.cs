...
public class EFE_Base: MonoBehaviour {
	...
	public EFE_PanelTransition firstPanel; //the first panel you want to display at game start
	...
	public EFE_PanelTransition currentPanel;
	public EFE_PanelTransition previousPanel;
	...
	void Start () {
		...
		OpenPanel(firstPanel.gameObject);
	}
	...
	public void OpenPanel(GameObject panel)
	{
		...
		currentPanel = FindPanel(panelName).GetComponent<EFE_PanelTransition>();
	...
	public IEnumerator  DoTransitionOutAFterDelay(EFE_PanelTransition prevPanel,EFE_PanelTransition panel)
	{
		...
		currentPanel.gameObject.active=false;
		//print("Started coroutine");
		yield return new WaitForSeconds(fadeDelay);
		currentPanel.gameObject.active=true;
